...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      const currentTranslateY = lastTransform?.translateY || 0;
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          ...
          const jTranslateY = jLastTransform?.translateY || 0;
  ...
  return (
    <div 
      className={`scroll-stack-scroller ${className} ${useWindowScroll ? 'scroll-stack-window-scroller' : ''}`.trim()} 
      ref={scrollerRef}
    >
