  ...
  return (
    <div className="flex flex-col space-y-1.5 group">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-white/20 outline-none transition-all focus:border-cyan-500/50 focus:bg-white/10 focus:ring-4 focus:ring-cyan-500/10 ${error ? 'border-red-500/50 bg-red-500/5' : ''}`}
      />
