  ...
  return (
    <div className="min-h-screen bg-white text-[#050521] font-sans pb-24">
      ...
      <section className="pt-28 pb-12 md:pt-36 md:pb-16 px-6 md:px-12 bg-slate-50 border-b-2 border-[#050521]">
        <div className="max-w-[1000px] mx-auto space-y-6 text-center flex flex-col items-center">
          {/* Breadcrumb & Badges */}
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-[#050521] leading-[1.05] text-center">
            {post.title}
          </h1>

          <p className="text-slate-600 font-mono text-sm md:text-base max-w-3xl leading-relaxed text-center">
            {post.excerpt}
          </p>

          <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-mono text-slate-500 pt-3 border-t border-slate-200 w-full">
          ...
          {post.sections.map((sec, idx) => (
            <article key={idx} id={`section-${idx}`} className="scroll-mt-32 space-y-4">
              {sec.heading !== "Introduction" && (
                <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight text-[#050521] pt-6 border-t border-slate-200">
                  {sec.heading}
                </h2>
              )}
