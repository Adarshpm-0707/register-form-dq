...
export default function EventForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await saveEventRegistration(formData);
      setSuccess(true);
          ...
          <AnimatePresence mode="wait">
            ...
            {success && (
              ...
              >
                 ...
                 <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter">Registration <span className="text-[#c6ff34]">Successful!</span></h2>
                  <p className="text-slate-400 text-sm md:text-lg font-medium">Your entry for the AI Workshop has been secured.</p>
                  <div className="pt-4 md:pt-8 space-y-4">
                    <motion.a 
                      ...
                      className="w-full py-4 md:py-6 bg-white/5 border border-[#c6ff34]/30 text-[#c6ff34] font-black text-[10px] sm:text-base md:text-xl uppercase tracking-widest rounded-xl md:rounded-2xl flex items-center justify-center gap-2 md:gap-3 hover:bg-[#c6ff34]/10 transition-all"
                    >
                    ...
                    <button 
                      onClick={() => navigate("/")}
                      className="w-full mt-4 bg-white/5 border border-white/10 text-white/40 font-black py-4 md:py-5 rounded-xl md:rounded-2xl uppercase tracking-[0.2em] text-[9px] md:text-[10px] hover:text-[#ff3b3b] hover:border-[#ff3b3b]/30 transition-all flex items-center justify-center gap-3 group"
                    >
