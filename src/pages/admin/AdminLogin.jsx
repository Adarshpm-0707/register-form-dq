...
export default function AdminLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setLoading(true);
    // For now, simple simulation. Real Firebase Auth can be added later.
    setTimeout(() => {
      setLoading(false);
    ...
    <div className="min-h-screen relative overflow-hidden bg-[#050521] text-white flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-10">
          <div className="text-[#c6ff34] font-black text-xs uppercase tracking-[0.5em] mb-4">Secure_Access</div>
          <h1 className="text-4xl font-black uppercase tracking-tighter">Admin <span className="text-[#c6ff34]">Login</span></h1>
        </div>
